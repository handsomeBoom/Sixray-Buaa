...
SIXray_ROOT = osp.join(HOME, "workspace/ml-project/datasets/")
...
class SIXrayDetection(data.Dataset):
    ...
    def __init__(self, root,
        ...
        self._annopath = osp.join('%s' % self.root, 'Anno_core_coreless_battery_sub_4000_3000', '%s.txt')
        ...
        ###这尼玛还有小写的tiff？
        self._imgpath1 = osp.join('%s' % self.root, 'cut_Image_core_coreless_battery_sub_5000_500', '%s.tiff')
        
        # TODO: image file format
        self._imgpath_jpg = osp.join('%s' % self.root, 'cut_Image_core_coreless_battery_sub_4000_3000', '%s.jpg')
        self.ids = list()
